...
.PHONY: help run run-linear run-github run-oura run-hacker-news run-trends run-fda-food run-iowa-liquor \
        sync sync-linear sync-github sync-oura sync-hacker-news sync-trends sync-fda-food sync-iowa-liquor \
